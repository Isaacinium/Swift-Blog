                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            ...
                            <h2 className="text-start d-block mt-1">Newest Posts</h2>
                        </div>
                    </div>
                </div>
            </section>
                                    ...
                                    <div className="mt-2" key={index}>
                                        <Link to={`/category/${c.slug}/`}>
                                            <div className="card bg-transparent">
                                                <img className="card-img" src={c.image} style={{ width: "100%", height: "80px", objectFit: "cover" }} alt="card image" />
                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            ...
                            <h2 className="text-start d-block mt-1">Popular Posts</h2>
                        </div>
                    </div>
                </div>
            </section>
